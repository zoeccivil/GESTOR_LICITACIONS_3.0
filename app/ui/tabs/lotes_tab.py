...
from ..dialogs.gestionar_lote_dialog import GestionarLoteDialog
...
class TabLotes(QWidget):
    ...
    def _fmt_money(self, value: float) -> str:
        ...
        # Events
    def _on_add(self):
        dlg = GestionarLoteDialog(self, "Añadir Lote", initial_data=None, participating_companies=self.participating_companies)
    ...
    def _on_edit(self):
        ...
        dlg = GestionarLoteDialog(self, "Editar Lote", initial_data=lote, participating_companies=self.participating_companies)
        if dlg.resultado is not None:
            data = dlg.resultado or {}
